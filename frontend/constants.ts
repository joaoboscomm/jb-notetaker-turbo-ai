...
export const THEMES: Record<string, { bg: string; border: string; label: string }> = {
  orange: { bg: '#F2B989', border: '#C06626', label: 'Orange' },
  yellow: { bg: '#F9E5A8', border: '#D4AF37', label: 'Yellow' },
  green: { bg: '#C8D5B9', border: '#788F63', label: 'Green' },
  teal: { bg: '#90B4B5', border: '#4A7A7B', label: 'Teal' },
  peach: { bg: '#F5CBA7', border: '#D35400', label: 'Peach' },
  blue: { bg: '#AED6F1', border: '#2E86C1', label: 'Blue' },
  pink: { bg: '#F5B7B1', border: '#C0392B', label: 'Pink' }
};

// SVG strings remain the same...
export const IMAGES = {
